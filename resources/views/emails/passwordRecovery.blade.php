                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ URL::asset('img/recovery-password.png') }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <span
                                                                        ...
                                                                        contraseña en el nombre de la empresa. Por favor
                                                                        tener en cuenta que Token expira en 10
                                                                        minutos
                                                                    </span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        ...
                                                                        restablecer su contraseña, por favor siga el
                                                                        siguiente enlace:</span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div align="left">
                                                                ...
                                                                <a href="{{ route('v2.page.update.password') }}?code={{ $code }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                                                ...
                                                                                favor, ignore este correo electrónico si
