                        ...
                        <div class="card-body">
                            ...
                            <div id="datos2">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-2 "><input type="date" name="fecha" id="fecha"
                                            class="form-control" onchange="validarCorte(this.value)" required></div>
                                    ...
                                    <div class="col-3 col-md-1 ">
                                        ...
                                        <input type="number" min="0" max="24" class="form-control"
                                            id="duracionh" name="duracionh" required>
                                    </div>
                                    <div class="col-3 col-md-1 ">
